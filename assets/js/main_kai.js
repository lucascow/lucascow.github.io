function updateNav_bk() {
    ...
    function l(e, t, n) {
        if (void 0 === n && 1 === e.nodeType) {
            ...
            if (n = e.getAttribute(i), "string" == typeof n) {
                try {
                    n = "true" === n ? !0 : "false" === n ? !1 : "null" === n ? null : +n + "" === n ? +n : De.test(n) ? pe.parseJSON(n) : n
                } catch (r) {}
                pe.data(e, t, n)
            } else n = void 0
        }
    ...
    var ye = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : q) !== I && _(t), t = t || I, H)) {
                if (11 !== m && (u = ve.exec(e)))
                    if (r = u[1]) {
                        if (9 === m) {
            ...
            var r = n.length > 0,
                ...
                a = function(i, a, s, l, u) {
                    var c, d, f, p = 0,
                        ...
                        w = b.length;
                    for (u && (L = a === I || a || u); h !== w && null != (c = b[h]); h++) {
                        if (o && c) {
                            for (d = 0, a || c.ownerDocument === I || (_(c), s = !H); f = e[d++];)
                                if (f(c, a || I, s)) {
                                    l.push(c);
                                    break
                                }
        ...
        var x, w, C, T, k, E, S, N, L, A, j, _, I, D, H, O, M, P, B, F = "sizzle" + 1 * new Date,
            q = e.document,
            $ = 0,
            z = 0,
            R = n(),
        ...
        w = t.support = {}, k = t.isXML = function(e) {
            ...
            return i !== I && 9 === i.nodeType && i.documentElement ? (I = i, D = I.documentElement, H = !k(I), (n = I.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), w.attributes = r(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), w.getElementsByTagName = r(function(e) {
                return e.appendChild(I.createComment("")), !e.getElementsByTagName("*").length
            }), w.getElementsByClassName = ge.test(I.getElementsByClassName), w.getById = r(function(e) {
            ...
            }, M = [], O = [], (w.qsa = ge.test(I.querySelectorAll)) && (r(function(e) {
            ...
            })), (w.matchesSelector = ge.test(P = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && r(function(e) {
                w.disconnectedMatch = P.call(e, "div"), P.call(e, "[s!='']:x"), M.push("!=", oe)
            }), O = O.length && new RegExp(O.join("|")), M = M.length && new RegExp(M.join("|")), t = ge.test(D.compareDocumentPosition), B = t || ge.test(D.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === I || e.ownerDocument === q && B(q, e) ? -1 : t === I || t.ownerDocument === q && B(q, t) ? 1 : A ? ee(A, e) - ee(A, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return j = !0, 0;
                var n, i = 0,
                    r = e.parentNode,
                    ...
                    s = [e],
                    l = [t];
                if (!r || !o) return e === I ? -1 : t === I ? 1 : r ? -1 : o ? 1 : A ? ee(A, e) - ee(A, t) : 0;
                if (r === o) return a(e, t);
            ...
            if ((e.ownerDocument || e) !== I && _(e), n = n.replace(ce, "='$1']"), w.matchesSelector && H && !X[n + " "] && (!M || !M.test(n)) && (!O || !O.test(n))) try {
                var i = P.call(e, n);
    ...
    pe.event = {
        ...
        trigger: function(t, n, i, r) {
            ...
            if (s = c = i = i || ie, 3 !== i.nodeType && 8 !== i.nodeType && !Ze.test(p + pe.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, t = t[pe.expando] ? t : new pe.Event(p, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : pe.makeArray(n, [t]), u = pe.event.special[p] || {}, r || !u.trigger || u.trigger.apply(i, n) !== !1)) {
                ...
                if (t.type = p, !r && !t.isDefaultPrevented() && (!u._default || u._default.apply(f.pop(), n) === !1) && Ie(i) && a && i[p] && !pe.isWindow(i)) {
    ...
    pe.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, a, s = pe.camelCase(t),
                    l = e.style;
                if (t = pe.cssProps[s] || (pe.cssProps[s] = I(s) || s), a = pe.cssHooks[t] || pe.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (r = a.get(e, !1, i)) ? r : l[t];
        ...
        css: function(e, t, n, i) {
            var r, o, a, s = pe.camelCase(t);
            return t = pe.cssProps[s] || (pe.cssProps[s] = I(s) || s), a = pe.cssHooks[t] || pe.cssHooks[s], a && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = mt(e, t, i)), "normal" === o && t in Ct && (o = Ct[t]), "" === n || n ? (r = parseFloat(o), n === !0 || isFinite(r) ? r || 0 : o) : o
        }
    ...
    var _t, It, Dt = pe.expr.attrHandle,
    ...
    pe.fn.extend({
        ...
        Mt && Ot || !Ht.test(t) ? Dt[t] = function(e, t, i) {
            var r, o;
            return i || (o = Dt[t], Dt[t] = r, r = null != n(e, t, i) ? t.toLowerCase() : null, Dt[t] = o), r
        } : Dt[t] = function(e, t, n) {
    ...
    pe.fn.load = function(e, t, n) {
        ...
        offset: function(e) {
            ...
            var t, n, i = {
                ...
                r = this[0],
                o = r && r.ownerDocument;
            return o ? (t = o.documentElement, pe.contains(t, r) ? ("undefined" != typeof r.getBoundingClientRect && (i = r.getBoundingClientRect()),
                n = te(o), {
...
$(window).resize(function() {
    ...
    function(e) {
        ...
        e.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                getImage: function(n, i) {
                    var r = 0,
                        o = function() {
                            n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, E("ImageLoadComplete")) : (r++, 200 > r ? setTimeout(o, 100) : a()))
                        },
                        a = function() {
        ...
        function l() {
            for (var e = D.length - 1; e >= 0; e--) u(D[e])
        }
        ...
        function h() {
            for (var e = D.length - 1; e >= 0; e--) f(D[e])
        }
        ...
        function j(e) {
            for (var t = D.length - 1; t >= 0; t--) D[t].node === e && (f(D[t]), D.splice(t, 1))
        }
        var _, I, D = [],
            H = !1,
            O = e.documentElement,
        ...
        e(), $(window).resize(function() {
            ...
            t && (t = !1, e())
        }, 250), $("#main").fitVids(), $(".sticky").Stickyfill();
        var n = function() {
